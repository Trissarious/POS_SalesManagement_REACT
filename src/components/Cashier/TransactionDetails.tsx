...
const TransactionDetails = () => {
    ...
    const handleLoginForRefund = () => {
        ...
        if (!loginRequest.username || !loginRequest.password) {
          ...
          axios.post('https://dilven-pos-sales-management-database-2.onrender.com/user/loginsales', loginRequest)
            .then((response) => {
              if (response.status === 200) {
                // Insert code for approval ^-^
                    ...
                    if (confirmed) {
                        setRefunded(true);
                        axios.put(`https://dilven-pos-sales-management-database-2.onrender.com/transaction/isRefunded?transactionid=${id}`, { refunded: true })
                          .then((response) => {
          ...
          axios.post('https://dilven-pos-sales-management-database-2.onrender.com/user/loginsales', loginRequest)
            .then((response) => {
              if (response.status === 200) {
                ...
                if (confirmed) {
                    setReturned(true);
                    axios.put(`https://dilven-pos-sales-management-database-2.onrender.com/transaction/isReturned?transactionid=${id}`, { returned: true })
                      .then((response) => {
